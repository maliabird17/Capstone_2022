...
## 3/6/9 comparison for all organs (contrast made across genotypes) ### 
...
timeseries_comparison <- function(fit_object, 
  ...
  contrast <- makeContrasts(
    ...
    Diff_End = (mut_9_g - mut_6_g) - (wt_9_g - wt_6_g),
    levels = organ_levels
  )
...
gfinal_369 <- timeseries_comparison(fitted,
                      'wt_3_g', 'wt_6_g', 'wt_9_g',
                      'mut_3_g', 'mut_6_g', 'mut_9_g',
                      TRUE,
                      "Gut_MUT-3-6-9_v_WT-3-6-9")
...
timeseries_comparison <- function(fit_object, 
  ...
  contrast <- makeContrasts(
    ...
    Diff_End = (mut_9_m - mut_6_m) - (wt_9_m - wt_6_m),
    levels = organ_levels
  )
...
mfinal_369 <- timeseries_comparison(fitted,
                      'wt_3_m', 'wt_6_m', 'wt_9_m',
                      'mut_3_m', 'mut_6_m', 'mut_9_m',
                      TRUE,
                      "Muscle_MUT-3-6-9_v_WT-3-6-9")
...
timeseries_comparison <- function(fit_object, 
  ...
  contrast <- makeContrasts(
    ...
    Diff_End = (mut_9_t - mut_6_t) - (wt_9_t - wt_6_t),
    levels = organ_levels
  )
...
tfinal_369 <- timeseries_comparison(fitted,
                      'wt_3_g', 'wt_6_g', 'wt_9_g',
                      'mut_3_g', 'mut_6_g', 'mut_9_g',
                      TRUE,
                      "Testes_MUT-3-6-9_v_WT-3-6-9")
